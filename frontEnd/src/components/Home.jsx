        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center text-center">
            <div className="w-full md:w-1/3 mb-4 md:mb-0">
              <h3 className="text-lg font-semibold mb-2 text-sky-400">Connectify</h3>
              <p className="text-sm">Streamline your meetings, boost productivity, and connect effortlessly.</p>
            </div>
            <div className="w-full md:w-1/3 mb-4 md:mb-0">
              <h3 className="text-lg font-semibold mb-2 text-sky-400">Contact Us</h3>
              <p className="text-sm">Email: support@connectify.com</p>
              <p className="text-sm">Phone: (123) 456-7890</p>
            </div>
            <div className="w-full md:w-1/3">
              <h3 className="text-lg font-semibold mb-2 text-sky-400">Follow Us</h3>
              <div className="flex justify-center space-x-4">
                <a href="#" className="text-gray-300 hover:text-sky-400 transition duration-300">
