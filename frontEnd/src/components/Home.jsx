    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-12">
        ...
        <p className="text-lg text-gray-600 mb-8 text-center max-w-2xl">
          Streamline your meetings, boost productivity, and connect effortlessly.
        </p>
        
        <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4 mb-12">
          <Link to="/register" className="w-full sm:w-auto">
            <button className="w-full px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300 text-sm font-medium shadow-md hover:shadow-lg">
              Get Started
            </button>
          </Link>
          <Link to="/signin" className="w-full sm:w-auto">
            <button className="w-full px-6 py-2 bg-white text-blue-600 border border-blue-600 rounded-md hover:bg-blue-50 transition duration-300 text-sm font-medium shadow-md hover:shadow-lg">
              Sign In
            </button>
          </Link>
        </div>
        ...
        <section className="w-full max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
              <h3 className="font-medium text-lg mb-2 text-center text-blue-600">Easy Scheduling</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
              <h3 className="font-medium text-lg mb-2 text-center text-blue-600">Team Collaboration</h3>
              <p className="text-gray-600 text-center text-sm">Connect and work together seamlessly with powerful collaboration tools.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
              <h3 className="font-medium text-lg mb-2 text-center text-blue-600">Smart Reminders</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center text-center">
            <div className="w-full md:w-1/3 mb-4 md:mb-0">
              <h3 className="text-lg font-semibold mb-2 text-blue-400">Connectify</h3>
              <p className="text-sm">Streamline your meetings, boost productivity, and connect effortlessly.</p>
            </div>
            <div className="w-full md:w-1/3 mb-4 md:mb-0">
              <h3 className="text-lg font-semibold mb-2 text-blue-400">Contact Us</h3>
              <p className="text-sm">Email: support@connectify.com</p>
